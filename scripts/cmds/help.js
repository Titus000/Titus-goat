...
const doNotDelete = "[ 🧜‍♂🌪 | ❤‍🔥OVERGAME bot ☠️]";
/** 
...
module.exports = {
	...
	onStart: async function ({ message, args, event, threadsData, getLang, role }) {
		const langCode = awai threadsData.get(event.threadID, "data.lang") || global.GoatBot.config.language;
		let customLang = {};
